...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      {/* Main content area */}
      <div className="flex-1 flex flex-col min-h-screen min-w-0 w-full lg:ml-64">
        {/* Desktop header */}
        ...
        {/* Page content */}
        <main className="flex-1 p-4 lg:p-6 pt-[72px] lg:pt-6 pb-20 lg:pb-6 overflow-x-hidden min-w-0">
          {children}
        </main>
      </div>
